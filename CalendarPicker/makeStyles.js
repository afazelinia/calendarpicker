...
const DEFAULT_SELECTED_BORDER_COLOR = '#00A39E';
const DEFAULT_SELECTED_TEXT_COLOR = '#000000';
const DEFAULT_TODAY_BACKGROUD_COLOR = '#CCCCCC';

export function makeStyles(scaler, backgroundColor, borderColor, textColor, todayBackgroundColor) {
  ...
  const SELECTED_BORDER_COLOR = borderColor ? borderColor : DEFAULT_SELECTED_BORDER_COLOR;
  return {
    calendar: {
      height: 320*scaler,
      marginTop: 10*scaler
